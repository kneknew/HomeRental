...
const SearchFilters = () => {
    ...
    return (
        <div 
            ...
            className="h-[55px] lg:h-[64] flex flex-row items-center justify-between border rounded-full"
        >
            ...
            <div className="p-2">
                <div className="cursor-pointer p-2 lg:p-4 bg-airbnb hover:bg-airbnb-dark transition rounded-full text-white">
                    <svg 
                        viewBox="0 0 32 32" 
                        style={{display:'block', fill:'none', height: '13px', width: '14px', stroke: 'currentColor', strokeWidth:4, overflow:'visible'}} 
